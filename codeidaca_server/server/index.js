...
// data yang kepake doang
app.use(config.URL_API + "/bootcampApply", routes.BootcampApply);
app.use(config.URL_API + "/modules", routes.Modules);
app.use(config.URL_API + "/routeActions", routes.RouteActions);
