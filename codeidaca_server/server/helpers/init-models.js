...
function initModels(sequelize) {
  ...
  const batch_student_evaluation = _batch_student_evaluation(
    sequelize,
    DataTypes
  );
  const bootcamp_apply = _bootcamp_apply(sequelize, DataTypes);
  const bootcamp_apply_progress = _bootcamp_apply_progress(
    sequelize,
    DataTypes
  );
  ...
  const content_section_material = _content_section_material(
    sequelize,
    DataTypes
  );
  ...
  const employee_client_contract = _employee_client_contract(
    sequelize,
    DataTypes
  );
  const employee_department_history = _employee_department_history(
    sequelize,
    DataTypes
  );
  ...
  const users_experiences_skill = _users_experiences_skill(
    sequelize,
    DataTypes
  );
  ...
  program_entity.hasOne(bootcamp_apply, {
    as: "bootcamp_apply",
    foreignKey: "boap_prog_id",
  });
