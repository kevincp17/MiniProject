...
import BootcampRegulerJS from "./views/bootcamp/BootcampRegulerJS";
import BootcampRegulerReactJS from "./views/bootcamp/BootcampRegulerReactJS";
  ...
  return useRoutes([
    {
      ...
      children: [
        ...
        { path: "BootcampRegulerJS", element: <BootcampRegulerJS /> },
        { path: "BootcampRegulerReactJS", element: <BootcampRegulerReactJS /> },
