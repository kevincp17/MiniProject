...
export const doSignupEmpRequest = (payload) => ({
  type: ActionType.ADD_SIGNUPEMP_REQUEST,
  payload,
});

export const doSignupEmpSucceed = (payload) => ({
  type: ActionType.ADD_SIGNUPEMP_SUCCEED,
  payload,
});

export const doSignupEmpFailed = (payload) => ({
  type: ActionType.SIGNUPEMP_FAILED,
  payload,
});
