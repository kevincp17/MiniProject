...
export default function BootcampRegulerReactJS() {
  const Bootcamp = [
    {
      id: 1,
      name: "NodeJS Fullstack",
      unavailable: false,
      link: "bootcampReguler",
    },
    {
      id: 2,
      name: "ReactJS Fullstack",
      unavailable: false,
      link: "bootcampRegulerReactJS",
    },
    {
      id: 3,
      name: "Javascript",
      unavailable: false,
      link: "bootcampRegulerJS",
    },
  ];
  const [SelectedBootcamp, setSelectedBootcamp] = useState(Bootcamp[0]);
  ...
  const Filtered =
    query === ""
      ...
      : Bootcamp.filter((Bootcamp) => {
          return Bootcamp.name.toLowerCase().includes(query.toLowerCase());
        });
  ...
  return (
    <div>
      ...
      <div class="grid grid-cols-3 gap-4 -mt-12">
        {/* Search */}
        <div class="py-6 col-start-1  ">
          <label
            class="flex float-right py-2.5 px-3 mr-2 text-sm font-medium"
            for="search"
          >
            Search
          </label>
        ...
        <div
          id="search"
          class="py-6 col-start-2 border-0 border-bottom-4 border-black"
        >
          <form class="">
            <Combobox value={SelectedBootcamp} onChange={setSelectedBootcamp}>
              <Combobox.Input
                className="w-full pl-2.5 p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                onChange={(event) => setQuery(event.target.value)}
                placeholder="NodeJS, ReactJS, Javascript"
              />
              <Combobox.Options className="w-full pl-2.5 p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500">
                {Filtered.map((Bootcamp) => (
                  <Combobox.Option
                    key={Bootcamp.id}
                    value={Bootcamp}
                    disabled={Bootcamp.unavailable}
                    className="hover:bg-gray-200"
                  >
                    <a href={Bootcamp.link}>{Bootcamp.name}</a>
                  </Combobox.Option>
                ))}
              </Combobox.Options>
            </Combobox>
        ...
        <div class="py-6 col-start-3 flex float-left">
          <button
            type="submit"
            class=" items-center h-10 px-3 ml-2 text-sm font-medium text-white bg-orange-700 rounded-lg border border-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800"
          >
            Search
          </button>
        </div>
        ...
        <div class="col-start-1 col-span-2 row-span-4 border-2 p-4">
          ...
          {/* what you will learn */}
          <div class="my-4 p-4 border-2 border-black rounded-md rounded-md bg-white">
          ...
          {/* Bootcamp Material */}
          <div class="my-4 p-4 border-2 border-black rounded-md bg-white">
            ...
            <Disclosure>
              ...
              <Disclosure.Panel className="ml-6 text-gray-500">
                React
              </Disclosure.Panel>
              <br></br>
              <Disclosure.Button className="py-2 inline-flex">
          ...
          {/* Description */}
          <div class="my-4 p-4 border-0 border-black rounded-md bg-white">
          ...
          {/* Instructors */}
          <div class="my-4 p-4 pb-12 border-2 border-black rounded-md bg-white">
          ...
          <div class="mx-2 pt-2" id="link video">
            <div class="w-full h-auto">
              <iframe
                width="340"
                height="240"
                src="https://www.youtube.com/embed/atKItcv56HE"
          ...
          <div class="mx-6 pt-4" id="keterangan video">
            <div class="pl-10">
              ...
              <p class="inline-flex pt-2 items-center">
                <button
                  type="button"
                  class="inline-flex w-full items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-orange-700 rounded-lg border border-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800"
                  onClick={() => window.alert("Succesfully Apply Bootcamp")}
                >
            ...
            <div>
              ...
              <p class="p-1 border-2 border-black rounded-md bg-white">
