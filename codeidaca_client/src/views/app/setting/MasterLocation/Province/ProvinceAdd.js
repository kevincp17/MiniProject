...
import { AddProvinceRequest } from '../../../../../redux-saga/actions/Province'
...
export default function SettingLocationAdd(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            dispatch(AddProvinceRequest(payload))
            props.closeAdd();
    ...
    return (
        ...
        <div className="w-full px-24">
            <div className='grid justify-items-stretch mx-12 border-2 border-slate-400 rounded-none'>
                <h1 className='font-bold p-2 border-b-2 border-slate-400 rounded-none'>Add Province</h1>
