                    ...
                    <div className="shadow overflow-hidden sm:rounded-md">
                            ...
                            <div className="mt-6 sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div className="sm:col-span-2 lg:col-span-3">
                                    ...
                                    <select
                                        ...
                                        {
                                            listOfMonth.map(data=>(
                                                <option className="capitalize" value={ data.value < 10 ? `-0${data.value}-` : `-${data.value}-` }>{data.name}</option>
                                            ))
                                        }
                                    </select>
                                    <select
                                ...
                                members && members.filter((el)=>{
                                    if(search==='' ||search==='Year' || search === 'Filter By Month' ){
                                        ...
                                        return el
                                    } else if(el.bulan === parseInt(search) ){
                                        return el
                                    }
                                })
                                .slice((currentPage-1)*12,currentPage*12).map((el)=>(
                                    <div>
                                        ...
                                        />
                                        {console.log(listOfMonth.indexOf(search))}
                                        <label 
                        ...
                        <div className="px-4 py-3 bg-gray-200 text-right sm:px-6 ">
                            <button
                                ...
                                className="focus:outline-none text-white bg-orange-600 hover:bg-orange-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900"
                            >
                                Save
                            </button>
                            <button
